...
@section('content')
<h1 class="text-3xl font-bold text-blue-800 mb-6">Guia d'jugadores</h1>
...
<p class="mb-4">
  <a href="{{ route('jugadores.create') }}" class="bg-blue-600 text-white px-3 py-2 rounded">Nou jugadora</a>
</p>
